"""
This file contains functions to generate scales and the scale degree chords defined by them.
"""
import itertools
...
#
# This prints out information related to the scales (a Tonnetz diagram), but it is not currently in use as it is tangential to the other parts of the project.
#
...
# These are a bunch of interesting scales to play with.
INTERESTING_SCALES = {
    #
